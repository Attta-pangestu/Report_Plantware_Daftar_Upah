...
async def get_column_definitions(
    ...
    try:
        ...
        agg_specs = {
            ...
            'total_premi': {'type': 'sum', 'fields': ['premi_pruning','premi_brondol'], 'match_prefix': 'premi_'},
            'jumlah_upah_kotor': {'type': 'sum', 'fields': ['gaji_pokok','total_tunjangan','total_premi']},
            'total_potongan': {'type': 'sum', 'fields': ['pot_bpjs_kesehatan_pekerja','pot_bpjs_pensiun_pekerja','pot_bpjs_pekerja_total','pot_bpjs_pek','pot_spsi','pot_pph21','pot_koreksi'], 'match_prefix': 'pot_dynamic_'},
